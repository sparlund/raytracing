...
bool ImGui::BeginBottomMainMenuBar()
{
    ...
    SetNextWindowSize(ImVec2(g.IO.DisplaySize.x/2, 50));
    PushStyleVar(ImGuiStyleVar_WindowRounding, 0.0f);
    PushStyleVar(ImGuiStyleVar_WindowMinSize, ImVec2(0, 0));
    ImGuiWindowFlags window_flags = ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoNav;
    bool is_open = Begin("##BottomMainMenuBar", NULL, window_flags);
    PopStyleVar(2);
